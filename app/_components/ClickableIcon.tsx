...
export default function ClickableIcon({ img, size, alt, label, isFileIcon, openWindow }: ClickableIconProps) {
    ...
    return (
        <div className={`flex justify-center items-center w-full p-[10%] rounded-md hover:bg-[#ffffff23] hover:cursor-pointer ${label ? 'aspect-square max-[800px]:w-[70%]' : 'aspect-square pt-[16%]'}`} onClick={openWindow}>
