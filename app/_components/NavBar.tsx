    ...
    return (
        <div className="flex h-full min-h-0 flex-col bg-[#00000080] p-[10%]">
            <div className="h-full flex flex-col items-center gap-[2%]">
                <ClickableIcon img="/folder-open.svg" alt="home" size={50} openWindow={() => openWindow("File Explorer")} />
                <ClickableIcon img="/square-terminal.svg" alt="home" size={50} openWindow={() => openWindow("Terminal")} />
            </div>
